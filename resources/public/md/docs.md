<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>nutrition.db.core</code> namespace.
...
Request middleware functions are located under the `nutrition.middleware` namespace.
