...
var or__3721__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__8922 = res;
(G__8922[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__8923){
var vec__8925 = p__8923;
var id = cljs.core.nth.call(null,vec__8925,(0),null);
var class$ = cljs.core.nth.call(null,vec__8925,(1),null);
var pid = (props["id"]);
...
var pname_8926 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_8926 === "key"))){
(o[pname_8926] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__8929 = jsprops;
(G__8929["defaultValue"] = value);

(G__8929["value"] = null);

(G__8929["onChange"] = ((function (G__8929,on_change,value){
return (function (p1__8927_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8927_SHARP_);
});})(G__8929,on_change,value))
);
...
var G__8931 = spec;
(G__8931["componentDidUpdate"] = ((function (G__8931){
return (function (){
var C = this;
...
(G__8931["componentWillUnmount"] = ((function (G__8931){
return (function (){
var C = this;
...
return (function (p1__8932_SHARP_,p2__8933_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__8932_SHARP_,p2__8933_SHARP_);
...
var vec__8935 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8935,(0),null);
var id = cljs.core.nth.call(null,vec__8935,(1),null);
var class$ = cljs.core.nth.call(null,vec__8935,(2),null);
...
var vec__8937 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__8937,(0),null);
var id_class = cljs.core.nth.call(null,vec__8937,(1),null);
...
var jsprops = (function (){var obj8941 = {};
(obj8941[reagent.impl.util.cljs_argv] = v);

(obj8941[reagent.impl.util.cljs_level] = level);

return obj8941;
})();
var k_8942 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__8943 = (((k_8942 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_8942);
if((k_SINGLEQUOTE__8943 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__8943);
}
...
var n__4608__auto___8944 = a.length;
var i_8945 = (0);
while(true){
if((i_8945 < n__4608__auto___8944)){
(a[i_8945] = reagent.impl.template.as_component.call(null,(a[i_8945]),level_SINGLEQUOTE_));
...
var n__4608__auto___8947 = a.length;
var i_8948 = (0);
while(true){
if((i_8948 < n__4608__auto___8947)){
if((i_8948 >= first_child)){
(a[i_8948] = reagent.impl.template.as_component.call(null,(a[i_8948]),level));
} else {
}

var G__8949 = (i_8948 + (1));
i_8948 = G__8949;
continue;
} else {
}
